...
module.exports = {
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/J5ukOs9.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Prince ser' : process.env.LOGO_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Prince🎗️/💝/✨/💖' : process.env.CMD_LIST,
