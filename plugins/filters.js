...
const array = ['Hi','alive','Prince','ayin','Mm','fan','song','love','git','single','Kanjav','Intro','Indro','Uff','prince','owner','Bot']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
