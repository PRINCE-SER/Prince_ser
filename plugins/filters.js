...
const array = ['spirit','Prince','Xxx','Vazha','Umbi','Song','Sed','Sarasu','single','ttps','Good night','menu','Lub','Oii','prince','Umma','Hai','Power','Poda','Ayin','bot','sed','Pavam','song','Pinne','photo','alive','Okay','Ok','Noob','Nee','nanban','Myre','mp3','Mm','Love','Line','Killadi','kanjav','ith','I love you','Hlo','Mair','help','Ha','group','bye','Bro','Bgm','bgm','Baby','Aysheri','ayn','Hi','Bot']
array.map( async (a) => {
...
await message.client.sendMessage(message.jid, fs.readFileSync('Prince_bgms/.mp3'), MessageType.audio, { mimetype: Mimetype.mpAudio,duration: Config.SAID, contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        ...
        var uri = encodeURI(match[1])
const array = ['Hi','spirit','Prince','Xxx','Vazha','Umbi','Lub','alive','Sarasu','single','Good night','menu','ttps','Song','Oii','Umma','Hai','Sed','prince','Power','Poda','Ayin','bot','sed','Pavam','song','Pinne','photo','Okay','Ok','Noob','Nee','nanban','Myre','mp3','Mm','Love','Line','Killadi','kanjav','ith','I love you','Hlo','Mair','help','Ha','group','bye','Bro','Bgm','bgm','Baby','Aysheri','ayn']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Hi','spirit','alive','Prince','ayin','Mm','song','love','git','single','Uff']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
