...
const array = ['Hi','spirit','alive','Prince','ayin','Mm','song','love','git','single','Kanjav','Intro','Indro','Uff','prince']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
