...
const array = ['spirit','Prince','Xxx','Vazha','Umbi','Song','Sed','Sarasu','single','Good night','menu','Lub','Oii','prince','Umma','Hai','Power','Poda','Ayin','bot','sed','Pavam','song','Pinne','photo','alive','Okay','Ok','Noob','Nee','nanban','Myre','mp3','Mm','Love','Line','Killadi','kanjav','ith','I love you','Hlo','Mair','help','Ha','group','bye','Bro','Bgm','bgm','Baby','Aysheri','ayn','Hi']
array.map( async (a) => {
